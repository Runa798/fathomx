...
- **🚧 状态（2026-05-29）：已进入**。细化计划见 [`docs/plans/phase3-skill-orchestration.md`](docs/plans/phase3-skill-orchestration.md)（含现状盘点：现有 skill/prompt 为 Lapis 通用版，需特化承载方法论；待 Heye 对齐 D1/D2/D3 后开工）。
