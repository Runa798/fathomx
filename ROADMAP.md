...
- **✅ 状态（2026-05-29）：已签收**（Heye 审计第一轮通过，进 Phase 3）。见 review [`docs/plans/phase2-spec-and-orchestration.md`](docs/plans/phase2-spec-and-orchestration.md#review2026-05-29--主体完成待-heye-确认)。产出：[规格](docs/specs/pm-deep-research-competitive-research-spec.md)·[rubric](docs/evaluation/rubric.md)·[接口](docs/specs/orchestration-interface.md)·[黄金样例](docs/evaluation/golden/running-coach-ai-upgrade.md)(自评 23/24)。关键发现：Lapis 仅 2 工具，v2.0 纯 Skill+prompt 承载产品字段、不改 Rust。
