...
## 7. 待 Heye 确认（不阻塞起草，影响落地口径）
1. **可信度分级统一口径**：采纳 Phase 1 的 **4-tier** 为权威（A-E 作展示别名）——确认？
2. **黄金样例深度**：Phase 2 先做**1 个课题到专家级完整参考** + 课题/rubric 规格化，另一个留 Phase 3——确认？
3. **黄金课题具体品类**：connected strength / 跑步教练 app / 智能跳绳·可穿戴——你倾向哪个（或指定）？
