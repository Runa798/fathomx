...
> 引擎接口设计见 [`orchestration-interface.md`](orchestration-interface.md)（WS4）；评测见 [`../eval/rubric.md`](../eval/rubric.md)（WS2）。
...
本规格通过 [`../eval/rubric.md`](../eval/rubric.md) 自评（WS2），并由 [`../eval/golden/`](../eval/golden/) 海外跑步教练 app 黄金样例验证（WS3）。Layer1↔Lapis 每步接口见 [`orchestration-interface.md`](orchestration-interface.md)（WS4）。
